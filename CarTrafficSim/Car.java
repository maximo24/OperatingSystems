...
public class Car extends Thread {
  ...
  public void run () {
    for (int I=1;  I<= 4; I++) {
      ...
      if (Synch.westgreen == false || Synch.westcount > 0) {
          System.out.println("At time " + Synch.timeSim.curTime() + " Car " + myName + " waits at westbound.\n");
          Synch.westcount++;
          Synch.mutex.release();
          try {
	  ...
	  //     wait through another red cycle for the next green.
        ...
        // code can be found in TrafficSystem class
      ...
      if (Synch.eastgreen == false || Synch.eastcount > 0) {
          System.out.println("At time " + Synch.timeSim.curTime() + " Car " + myName + " waits at eastbound\n");
          Synch.eastcount++;
          Synch.mutex.release();
          try{
    ...
    System.out.println("At time " + Synch.timeSim.curTime() + " Car "+ myName + " has stopped and its driver went out.\n");
