...
public class Reader extends Thread {
  ...
  public void run () {
    for (int I = 0;  I < 5; I++) {
      ...
      if (Synch.active_wrt == 1 || Synch.wait_wrt > 0) {
          Synch.wait_read++;
      }
      else {
          Synch.read.release();
      ...
      // read operations performed their duties, subtract
      Synch.active_read--;
      Synch.readcount--;
      ...
      // check if it's on last active reader and if their are write requests waiting
      if (Synch.active_read == 0 && Synch.wait_wrt > 0) {
          Synch.wrt.release();
          Synch.active_wrt = 1;
          Synch.wait_wrt--;
      }
